...
The ``web3.vap.Contract`` object makes it easy to interact with smart contracts on the vapory blockchain.
...
.. code-block:: javascript
    ...
    new web3.vap.Contract(jsonInterface[, address][, options])
...
.. code-block:: javascript
    ...
    var myContract = new web3.vap.Contract([...], '0xde0B295669a9FD93d5F28D9Ec85E40f4cb697BAe', {
...
The :ref:`json interface <glossary-json-interface>` object derived from the `ABI <https://github.com/vaporyco/wiki/wiki/Vapory-Contract-ABI>`_ of this contract.
...
.. code-block:: javascript
    ...
    var contract1 = new vap.Contract(abi, address, {gasPrice: '12345678', from: fromAddress});
...
.. code-block:: javascript
    ...
    // web3.js
    var MyContract = new web3.vap.contract(abi, address);
