...
var vapjsSigner = require("vapjs-signer");
...
var tests = [
    {
        ...
        // signature from vap_signTransaction
    ...
    },
    {
        ...
        // web3.vap.signTransaction({from: "0xEB014f8c8B418Db6b45774c326A0E64C78914dC0", gasPrice: "230000000000", gas: "50000", to: '0xFCAd0B19bB29D4674531d6f115237E16AfCE377c', value: "1000000000000000000", data: "0x0123abcd"}).then(console.log);
        // signature from vap_signTransaction
...
describe("eth", function () {
    describe("accounts", function () {
        ...
        tests.forEach(function (test, i) {
            it("signTransaction must compare to vap_signTransaction", function(done) {
                var vapAccounts = new Accounts();

                var testAccount = vapAccounts.privateKeyToAccount(test.privateKey);
        ...
        tests.forEach(function (test, i) {
            it("signTransaction using the iban as \"to\" must compare to vap_signTransaction", function(done) {
                var vapAccounts = new Accounts();
        ...
        tests.forEach(function (test, i) {
            it("signTransaction will call for nonce", function(done) {
                ...
                provider.injectValidation(function (payload) {
                    ...
                    assert.equal(payload.method, 'vap_getTransactionCount');
                    assert.deepEqual(payload.params, [test.address, "latest"]);
                });

                var vapAccounts = new Accounts(web3);
        ...
        tests.forEach(function (test, i) {
            it("recoverTransaction, must also recover old signature from vap-signer", function() {
                var vapAccounts = new Accounts();

                var oldSignature = vapjsSigner.sign(test.transaction, test.privateKey);
