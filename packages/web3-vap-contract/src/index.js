...
var Subscription = require('@vapory/web3-core-subscriptions').subscription;
...
var Contract = function Contract(jsonInterface, address, options) {
    ...
    if(!(this instanceof Contract)) {
        throw new Error('Please use the "new" keyword to instantiate a web3.vap.contract() object!');
    }
    ...
    // create topics based on filter
        ...
        if (event.name !== 'ALLEVENTS') {
            var indexedTopics = event.inputs.filter(function (i) {
                ...
                // TODO: https://github.com/vaporyco/web3.js/issues/344
...
Contract.prototype._executeMethod = function _executeMethod(){
    var _this = this,
        ...
        vapAccounts = _this.constructor._ethAccounts || _this._ethAccounts;
    ...
    if(args.generateRequest) {
        ...
        if(args.type === 'call') {
            payload.method = 'vap_call';
            payload.format = this._parent._decodeMethodReturn.bind(null, this._method.outputs);
        } else {
            payload.method = 'vap_sendTransaction';
        }
        ...
        switch (args.type) {
            case 'estimate':
                ...
                var estimateGas = (new Method({
                    ...
                    accounts: vapAccounts, // is vap.accounts (necessary for wallet signing)
            ...
            case 'send':
                ...
                var sendTransaction = (new Method({
                    ...
                    requestManager: _this._parent._requestManager,
                    accounts: _this.constructor._ethAccounts || _this._ethAccounts, // is vap.accounts (necessary for wallet signing)
                    defaultAccount: _this._parent.defaultAccount,
                    defaultBlock: _this._parent.defaultBlock,
