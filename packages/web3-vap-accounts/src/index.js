...
var Account = require("vap-lib/lib/account");
var Hash = require("vap-lib/lib/hash");
var RLP = require("vap-lib/lib/rlp");
var Nat = require("vap-lib/lib/nat");
...
var Accounts = function Accounts() {
    ...
    this._vaporyCall = {};
    _.each(_vaporyCall, function (method) {
        method.attachToObject(_this._vaporyCall);
...
Accounts.prototype.signTransaction = function signTransaction(tx, privateKey, callback) {
    ...
    // Otherwise, get the missing info from the Vapory Node
    return Promise.all([
        isNot(tx.chainId) ? _this._vaporyCall.getId() : tx.chainId,
        isNot(tx.gasPrice) ? _this._vaporyCall.getGasPrice() : tx.gasPrice,
        isNot(tx.nonce) ? _this._vaporyCall.getTransactionCount(_this.privateKeyToAccount(privateKey).address) : tx.nonce
    ]).then(function (args) {
...
Accounts.prototype.hashMessage = function hashMessage(data) {
    ...
    var vapMessage = "\x19Vapory Signed Message:\n" + message.length + message;
...
// Taken from https://github.com/vaporycojs/vaporyjs-wallet
...
// http://web3js.readthedocs.io/en/1.0/web3-vap-accounts.html
